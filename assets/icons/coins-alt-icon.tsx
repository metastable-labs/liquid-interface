...
const CoinsAltIcon = ({ fill = '#fff', height = 18, width = 18 }: IconProps) => (
  <Svg width={width} height={height} fill="none">
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.125}
      d="M13.875 5.737v3.75c0 2.34-2.182 4.013-4.875 4.013-2.692 0-4.875-1.673-4.875-4.013v-3.75C4.125 3.397 6.308 1.5 9 1.5c1.35 0 2.565.472 3.45 1.237.878.773 1.425 1.83 1.425 3Z"
    />
  </Svg>
);
export default CoinsAltIcon;
